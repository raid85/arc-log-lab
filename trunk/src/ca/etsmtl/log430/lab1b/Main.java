...
public class Main {
	...
	public static void main(String argv[]) {
		...
		if (argv.length != 2 && argv.length !=3) {      
			...
			// Instantiate the Severity Filter Threads
			...
			// Instantiate the Status Filter Threads
			Thread KeywordFilter3 = new StatusFilter("NOU", true, pipe04, pipe13);
			...
			Thread FileWriterFilter2 = new FileWriterFilter("dataout2Sys2.txt", pipe11);
