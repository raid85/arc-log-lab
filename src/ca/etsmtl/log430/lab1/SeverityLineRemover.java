...
public class SeverityLineRemover extends Thread {
	...
	public SeverityLineRemover(PipedWriter InputPipe1, PipedWriter InputPipe2,
		...
		try {
			...
			System.out.println("SeverityLineRemover:: connected to upstream filters.");
		} catch (Exception Error) {
			System.out.println("SeverityLineRemover:: Error connecting input pipes.");
		} // try/catch

		try {
			// Connect outputPipe1 to downstream filter
			this.OutputPipe1 = OutputPipe1;
			System.out.println("MSeverityLineRemover:: connected to downstream filter.");
		} catch (Exception Error) {
			System.out.println("SeverityLineRemover:: Error connecting output pipe.");
		} // catch
