				...
				if (myDelivery != null)	{	
					...
					if(myDelivery.getNotAssigned()){
						...
						if(checkConflicts()){
							...
							System.out.println ("Heure de d�part (int) de la livraison choisie...... "+myDelivery.getEstimatedDepartureTime100());
							...
							for (int i=0; i<myDriver.getDeliveriesAssigned().getListSize();i++){
								...
								System.out.println("Heure d'arrivée de la  "+i+"  livraison  : "+myDriver.getDeliveriesAssigned().getDelivery().getDesiredDeliveryTime100());
